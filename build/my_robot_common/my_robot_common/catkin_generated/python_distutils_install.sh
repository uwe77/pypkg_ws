...
echo_and_run cd "/home/uwe/pypkg_ws/src/my_robot_common/my_robot_common"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/uwe/pypkg_ws/src/my_robot_common/my_robot_common/setup.py" \
     \
    build --build-base "/home/uwe/pypkg_ws/build/my_robot_common/my_robot_common" \
    install \
    --root="${DESTDIR-/}" \
